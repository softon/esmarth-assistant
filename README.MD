...
```powershell
pyinstaller --noconfirm --clean --onefile --windowed --name "E-Samarth-Marks-Entry-Assistant" --icon "app.ico" --hidden-import playwright.sync_api --add-data "sample_data;sample_data" app.py
```
